...
다음 조건을 따라 광고 카피를 작성해주세요:
1. 당신만의 독특한 어조와 문체를 사용하세요. 하이쿠의 철학적 간결함을 담아내세요.
2. 청자에게 정보를 전달하기보다는, 당신의 시선에서 느껴지는 경험과 감정을 표현하세요.
...
[제약사항]
- 한 문장으로 작성하되, 자연스럽고 시적이어야 합니다.
- 청자 대신 당신의 시선으로 표현하세요.
