...
PERSONAS = {
    "파블로 네루다": {
        ...
        "sample": "바람은 당신의 마음에 시를 속삭입니다; 그곳에서 사랑을 만나네. 🌬️❤️",
        "category": "literature"
    },
    "프리드리히 니체": {
    ...
    "태연": {
        ...
        "sample": "사계절이 스치는 이곳에서 잊었던 꿈을 다시 찾아볼래; 함께라면 더 빛날 거니까. 🍃🌸",
        "category": "entertainment"
    },
    "BTS": {
        "description": "글로벌 감성과 공감 능력을 바탕으로 희망과 열정을 다채로운 스타일로 표현하며, 세대 간 연결고리를 만들어낸다.",
        "sample": "우리의 열정은 멈추지 않아; 함께 미래를 향해 달려가볼래! 너는 너만의 봄날과 소우주를 찾아야해 🌟🔥",
        "category": "entertainment"
    },
    "에스파": {
    ...
    "블랙핑크": {
        ...
        "sample": "우리처럼 뜨겁게 즐겨봐! 자신감을 가지고! forever young!🔥🌟",
        "category": "entertainment"
    },
    "뉴진스": {
    ...
    "아이묭": {
        ...
        "sample": "익숙한 거리에서 새로운 추억을 함께 만들어보자고 🚶‍♀️🌟",
        "category": "entertainment"
    },
    "저스틴 비버": {
...
당신은 해운대를 방문했습니다. 당신의 관점에서 느껴지는 해운대의 본질과 감정을 한 문장으로 표현해주세요. 아래 조건을 반드시 따르세요:
1. 당신의 고유한 문체와 말투를 사용하세요.
2. 청자에게 정보를 제공하지 말고, 해운대를 경험한 당신의 감정을 담아내세요.
3. 예시는 참고용입니다: {persona_data['sample']}
