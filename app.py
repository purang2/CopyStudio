...
st.video("image/copybara_santa_video_audio.mp4", loop=False, autoplay=True,subtitles="image/subtitles.vtt")
...
radio_city_captions = [
    "바다 냄새 맡으며 여유롭게 걸어볼래요? 강릉이 기다리고 있어요.",             # 강릉
    "고즈넉한 강화도의 섬마을에서 잠시 멈춰 쉬어가도 좋아요.",                 # 강화도
    "푸른 바다와 따뜻한 햇살이 반겨주는 거제의 품에 안겨볼래요?",              # 거제
    "시간이 천천히 흐르는 경북 영주, 마음도 가벼워질 거예요.",                 # 경북 영주
    "천년의 이야기가 묻어 있는 경주에서 시간을 거슬러 올라가 봐요.",           # 경주
    "백제의 숨결이 남아있는 공주에서 오래된 이야기를 만나보세요.",              # 공주
    "빛과 예술이 흐르는 광주, 걸을 때마다 새로운 감동이 있어요.",              # 광주
    "남원에서는 춘향이의 사랑처럼 애틋한 순간들이 기다리고 있어요.",           # 남원
    "동화책 같은 풍경, 남이섬에서 사계절의 아름다움을 만나보세요.",            # 남이섬
    "바다를 품은 남해의 길, 푸른 풍경이 반짝이고 있어요.",                     # 남해
    "가을이면 단풍으로 물드는 내장산, 꼭 한 번은 가봐야 할 곳이에요.",         # 내장산
    "담양 죽녹원에선 초록빛 대숲이 속삭이는 소리를 들어보세요.",               # 담양
    "대관령 고갯길, 상쾌한 바람에 마음도 한결 가벼워질 거예요.",               # 대관령
    "뜨거운 청춘이 빛나는 거리, 대구 동성로와 삼성 라이온즈의 열기를 느껴보세요.", # 대구 동성로
    "대구 서문시장은 야경이 정말 예뻐요. 오래된 정취가 가득하답니다.",          # 대구 서문시장
    "활력 넘치는 도시 대구, 삼성 라이온즈의 야구 열기를 함께 즐겨보세요.",        # 대구
    "과학과 문화의 도시 대전, 상상보다 더 많은 즐거움이 있어요.",              # 대전
    "신비로운 마이산, 어디서도 보지 못한 기암괴석이 기다리고 있어요.",         # 마이산
    "목포 항구의 바다 냄새와 함께 시간을 천천히 흘려보내요.",                  # 목포
    "문경새재 옛길을 걷다 보면 나도 모르게 마음이 평온해질 거예요.",            # 문경
    "보성 녹차밭은 초록빛 물결이 가득해요. 차향에 취해보는 건 어때요?",         # 보성
    "부산 남포동의 골목골목을 걸으며 숨은 맛집을 찾아보세요.",                 # 부산 남포동
    "서면 거리에서 젊음의 열기를 느껴봐요. 친구들과 함께라면 더 좋아요.",       # 부산 서면
    "부산 해운대는 언제나 반짝이는 바다로 마음을 설레게 해요.",                # 부산 해운대
    "서울 잠실에서는 LG 트윈스와 두산 베어스의 야구 경기가 기다리고 있어요.",   # 서울 강남
    "서울 남산타워에서 내려다보는 야경은 정말 아름다워요. 꼭 올라가 보세요.",    # 서울 남산타워
    "서울 동대문에선 패션과 열정이 가득해요. 마음에 드는 걸 꼭 찾을 거예요.",    # 서울 동대문
    "서울 명동은 쇼핑의 천국이죠. 가볍게 산책하며 마음을 채워보세요.",           # 서울 명동
    "서울숲에선 도심 속 여유를 만날 수 있어요. 잠시 쉬어가도 괜찮아요.",         # 서울 서울숲
    "서울 종로에선 전통과 현대가 손을 잡고 걸어가는 느낌이 들어요.",           # 서울 종로
    "설악산과 바다를 함께 품은 속초는 언제나 사랑스러워요.",                   # 속초
    "수원 화성에서의 산책과 수원 삼성 블루윙즈 축구 경기, 둘 다 놓치지 마세요!", # 수원
    "순천만 갈대밭의 황금빛 물결은 마음을 따뜻하게 만들어줘요.",                # 순천
    "안동 하회마을에선 시간이 멈춘 듯한 고즈넉함을 만날 수 있어요.",            # 안동
    "안면도 바다의 고요한 파도 소리를 들으며 하루를 마무리해보세요.",            # 안면도
    "서핑의 성지, 양양에서 푸른 바다를 가르며 신나게 놀아봐요.",               # 양양
    "여수 밤바다의 반짝이는 불빛은 잊지 못할 추억을 선물해줄 거예요.",           # 여수
    "용인은 놀이와 즐거움이 가득해요. 하루 종일 웃음이 끊이지 않을 거예요.",      # 용인
    "울산 태화강과 울산 HD FC의 축구 경기에서 짜릿한 응원을 즐겨보세요.",         # 울산
    "원주의 숲길에서 나만의 조용한 힐링 시간을 가져보세요.",                    # 원주
    "익산에선 백제의 흔적을 따라 걷다 보면 마음이 편안해져요.",                # 익산
    "송도의 해질녘 풍경은 정말 멋져요. 도시의 활력을 한껏 느껴보세요.",          # 인천 송도
    "인천에선 바다와 도시의 시간이 함께 흘러가요. 여유를 느껴보세요.",           # 인천
    "전주의 한옥마을에서 전북현대 모터스의 열정적인 축구 경기도 함께해요.",        # 전주
    "제부도의 바다길은 마법처럼 열렸다가 닫혀요. 놓치지 말고 꼭 걸어보세요.",     # 제부도
    "제주도에선 바람, 돌, 그리고 나만의 여유를 만날 수 있어요.",                # 제주
    "서귀포의 한라산과 푸른 바다를 바라보며 힐링하는 시간을 가져보세요.",         # 제주도 서귀포
    "천안 삼거리의 따뜻한 정취와 호두과자를 맛보면 마음이 말랑해질 거예요.",      # 천안
    "철원 한탄강의 절경은 자연이 주는 놀라운 선물 같아요.",                    # 철원 한탄강
    "춘천의 호반길에서 시간을 천천히 흘려보내는 건 어떨까요?",                  # 춘천
    "파주에선 평화의 길을 걸으며 천천히 마음을 내려놓아도 좋아요.",             # 파주
    "포항 스틸야드에서 울려 퍼지는 열정적인 응원, 꼭 경험해보세요.",             # 포항
]
...
저는 AI 카피라이터 카피바라입니다. ㅎㅎ   

창의적이고 감성적인 카피로 당신의 대한민국 관광지를  
더 특별하게 만들어드리는 역할을 합니다  


👋 처음 오셨나요?  
            1️⃣ 아래 [타겟 설정]에서 지역과 세대를 선택하세요  
            2️⃣ 계절과 MBTI를 선택할 수 있습니다 (선택사항)  
            3️⃣ 광고 카피를 생성하고 결과를 분석하세요  
            4️⃣ 좌측 메뉴바에서 생성된 프롬프트를 손쉽게 검토/수정하세요  
